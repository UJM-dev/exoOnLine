...
function add_form_choice_edit(multiple_response, unique_response, add, Response_number, 
                              Response, point, comment, expected_response, order, source_image_add, nbResponses, typeQCM) {
    ...
    if (typeQCM == 1) {
        $('#ujm_exobundle_interactionqcmtype_typeQCM').append('<option selected="selected" value="1">' + multiple_response + '</option><option value="2">'
                                                              + unique_response + '</option>')
    } else {
        $('#ujm_exobundle_interactionqcmtype_typeQCM').append('<option value="1">' + multiple_response + '</option><option selected="selected" value="2">'
                                                              + unique_response + '</option>')
    }
    ...
    $('#ujm_exobundle_interactionqcmtype_choices').after('<table style="border: 1px solid black;" id="newTable"><tr> <th>' + Response_number + '</th> <th>'
                                                         + Response + '</th> <th>' + point + '</th> <th>' + comment + '</th> <th>' + expected_response + 
                                                         '</th> <th>' + order + '</th> <th>------</th> <th>------</th> </tr></table>');
    $('#add_choice').css({
        "display":"block",
        "color": "green",
        "float":"right"
